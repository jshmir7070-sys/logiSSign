...
## Tasks
- [x] **T01: settings/page.tsx 1,268줄→98줄 — 7개 탭 컴포넌트 완전 분리** — ProfileTab, CategoryTab, SealTab, DocumentsTab, BillingTab, NotificationTab, AdminsTab을 components/portal/settings/ 폴더로 추출
  - Estimate: 30min

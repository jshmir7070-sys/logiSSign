      ...
      <div className="flex items-center gap-4">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="메뉴 검색"
            className="h-9 w-[220px] rounded-xl bg-surface-container-low pl-9 pr-4 text-[13px] text-on-surface placeholder:text-on-surface-variant/40 transition-all focus:outline-none focus:ring-2 focus:ring-primary/20"
          />
        </div>

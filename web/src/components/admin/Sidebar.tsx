    ...
    <aside className="fixed left-0 top-0 bottom-0 w-[240px] bg-sidebar flex flex-col z-50">
      ...
      <div className="px-4 py-5 flex items-center gap-3 bg-white/[0.04]">
        ...
        <div className="min-w-0">
          <p className="text-white/90 font-body text-[13px] font-medium truncate">Admin Profile</p>
          <p className="text-white/40 font-body text-[11px] truncate">admin@precision.io</p>
        </div>
      </div>
    </aside>
  )

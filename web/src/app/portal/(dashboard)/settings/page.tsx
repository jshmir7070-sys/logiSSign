      ...
      <div className="bg-surface-container-lowest rounded-2xl shadow-ambient p-8">
        ...
        <div className="flex items-center justify-between p-5 rounded-xl bg-surface-container-low">
          <div>
            ...
            <p className="text-2xl font-data font-bold text-primary mt-1">Basic</p>
            <p className="text-sm text-on-surface-variant font-data mt-1">₩49,900 / 월</p>
          </div>
          <div className="text-right">
            <p className="text-sm text-on-surface-variant font-korean">다음 결제일</p>
            <p className="text-sm font-data font-semibold text-on-surface mt-1">2026-04-01</p>
          </div>
        </div>
        <button className="mt-4 h-10 px-6 rounded-xl bg-surface-container-high text-on-surface-variant font-label font-medium text-sm hover:bg-surface-container-highest transition-colors font-korean">플랜 변경</button>
      </div>
      <div className="bg-surface-container-lowest rounded-2xl shadow-ambient p-8">
        ...
        <div className="flex items-center gap-4 p-4 rounded-xl bg-surface-container-low">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-on-surface-variant font-korean">결제 수단을 등록하세요</p>
          </div>
          <button className="h-9 px-4 rounded-lg bg-primary text-white text-sm font-korean hover:bg-primary/90">등록</button>
        </div>
      </div>
    </div>
  );

  ...
  return (
    <div className="landing-page">
      ...
      <main className="content">
        ...
        <nav className="nav fade-in">
          <div className="nav-brand">
            ...
            <span className="nav-name">logi<span className="accent">SSign</span></span>
          </div>
      ...
      <style>{`
        ...
        .nav-name { font-size:18px; font-weight:800; color:white; letter-spacing:-0.5px; }
        ...
        .hero-logo { width:80px; height:80px; object-fit:contain; margin-bottom:8px; }

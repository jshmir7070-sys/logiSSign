  ...
  return (
    <div className="coming-soon-page">
      ...
      <main className="content">
        ...
        {/* Badge */}
        <div className="badge fade-in" style={{ animationDelay: '1.2s' }}>
        ...
        {/* CTA */}
        <div className="cta-section fade-in" style={{ animationDelay: '1.6s' }}>
        ...
        {/* Pricing Preview */}
        <div className="pricing-preview fade-in" style={{ animationDelay: '1.8s' }}>
        ...
        {/* Footer */}
        <footer className="footer fade-in" style={{ animationDelay: '2.0s' }}>
